...
- Phase 11 includes typed update manifests, SHA-256 and ECDSA verification primitives, guarded update-state transitions, and a protected signed-release workflow. The app remains discovery-only until automatic download and apply are wired.
