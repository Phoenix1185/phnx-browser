...
- The required three-dot browser menu, About screen, branding, sharing, find-in-page, page zoom, text size, desktop-site toggle, pinned home-screen shortcuts, profile-scoped download records/statuses, and Android DownloadManager integration.
