...
- Profile-scoped identity presets, consistency validation, persistence, page-visible screen/viewport metric overrides, and a WebView capability-reporting editor with 20 selectable device and browser profiles plus System Default.
