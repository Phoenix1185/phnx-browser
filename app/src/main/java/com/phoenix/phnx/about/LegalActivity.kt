...
class LegalActivity : AppCompatActivity() {
    ...
    private fun addNotices(parent: LinearLayout) {
        ...
        section(parent, "HProxy", "Free proxy mode reads public endpoint data from HProxy. HProxy is a third-party service and is not controlled or operated by PHNX. Endpoint availability, ownership, privacy, and safety are not guaranteed.")
