...
This is the static GitHub Pages site for PHNX Browser. It uses the repository's official icon and links only to the actual Phoenix repository, issues, releases, and Actions pages. The root `index.html` redirects legacy root-based Pages configurations into this maintained site directory.
